...
namespace ImageViewer
{
    ...
    public partial class App : Application
    {
        ...
        public static ImageUpdateService ImageUpdateService { get; private set; }
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            ImageUpdateService = new ImageUpdateService(new SQLiteImageRepository(loader.ConnectionString, loader.ImageFolderPath), TagGetService);
